      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-4 sm:px-6">
        ...
        <div className="flex gap-1.5 sm:gap-3 items-center">
          ...
          <button 
            ...
            className={`relative p-2 rounded-xl border border-zinc-200 hover:bg-zinc-50 hover:text-emerald-600 text-zinc-600 transition-all duration-200 cursor-pointer ${
              location.pathname === "/wishlist" ? "bg-zinc-50 text-emerald-600 border-emerald-300" : ""
            }`}
            title="Wishlist"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button 
            ...
            className={`relative p-2 rounded-xl border border-zinc-200 hover:bg-zinc-50 hover:text-emerald-600 text-zinc-600 transition-all duration-200 cursor-pointer ${
              location.pathname === "/cart" ? "bg-zinc-50 text-emerald-600 border-emerald-300" : ""
            }`}
            title="Shopping Cart"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {cartCount > 0 && (
              <span className="absolute -top-1.5 -right-1.5 bg-emerald-500 text-white text-[9px] font-bold w-5 h-5 rounded-full flex items-center justify-center border-2 border-white shadow-sm">
                {cartCount}
              </span>
            )}
          </button>
